<?php
	...
	*/
	...
	define('LOTUS_EZSQL_VERSION','2.17');
	...
	*/
	...
	class ezSQLcore
	{
		...
		*/
		...
		function get_row($query=null,$output=LOTUS_OBJECT,$y=0)
		{
			...
			{
				$this->show_errors ? trigger_error(" \$db->get_row(string query, output type, int offset) -- Output type must be one of: LOTUS_OBJECT, ARRAY_A, ARRAY_N",E_USER_WARNING) : null;
			}
		...
		*/
		...
		function get_results($query=null, $output = LOTUS_OBJECT)
		{
		...
		*/
		...
		function vardump($mixed='')
		{
			...
			{
				echo "<font color=800080><b>ezSQL</b> (v".LOTUS_EZSQL_VERSION.") <b>Variable Dump..</b></font>\n\n";
			}

			$var_type = gettype ($mixed);
			print_r(($mixed?$mixed:"<font color=red>No Value / False</font>"));
			echo "\n\n<b>Type:</b> " . ucfirst($var_type) . "\n";
			echo "<b>Last Query</b> [$this->num_queries]<b>:</b> ".($this->lastQuery?$this->lastQuery:"NULL")."\n";
		...
		*/
		...
		function debug($print_to_screen=true)
		{
			...
			{
				echo "<font color=800080 face=arial size=2><b>ezSQL</b> (v".LOTUS_EZSQL_VERSION.") <b>Debug..</b></font><p>\n";
			}
